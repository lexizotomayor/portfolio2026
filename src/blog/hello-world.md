...
I built this with [Eleventy](https://www.11ty.dev/), a static site generator that I've come to love for its simplicity and flexibility. The design is intentionally minimal — dark background, warm type, clean layout. I wanted the content to breathe.
